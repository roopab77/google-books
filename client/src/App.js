      ...
      .then(({ data }) => {
        ...
        const bookList = data.items.map(book => {
          return {
            ...
            authors: book.volumeInfo.authors || "Roopa Byrichetty",
            description: (book.searchInfo)? book.searchInfo.textSnippet : "No Description",
            link: book.volumeInfo.infoLink,
            image: ( book.volumeInfo.imageLinks.thumbnail)?book.volumeInfo.imageLinks.thumbnail : "https://via.placeholder.com/150"
          }
        })
